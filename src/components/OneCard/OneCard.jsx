...
<div>
     <div>
        <div className={styles.imgFirst}>
            <img src="https://cdn.kodixauto.ru/media/image/609bb310a10eff0001a590f7" alt="" />
        </div>
        ...
        <Link to="/#">Официальные дилеры BMW</Link>
            ...
            <div className={styles.img}>
                <img src="https://cdn.kodixauto.ru/media//media/resized_image/webp/654b5c59f28fa87f7e0bd8b5/1200/0" alt="" />
            </div>
            ...
            <div className={styles.title}>
              <div> 
               ...
               <div className={styles.p}>
                ...
                <p>Интерьер: Кожа Vernasca с перфорацией особого дизайна "Черный"</p>
